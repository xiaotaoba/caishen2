...
namespace Pannet.Utility
{
    ...
    string body, bool isBodyHtml, Encoding encoding, bool isAuthentication, params string[] files)
        {
            SmtpClient smtpClient = new SmtpClient(server,Convert.ToInt16(ConfigurationSettings.AppSettings["SmtpPort"]));
        ...
        //static readonly string smtpServer = System.Configuration.ConfigurationSettings.AppSettings["SmtpServer"];
        //static readonly string userName = System.Configuration.ConfigurationSettings.AppSettings["UserName"];
        //static readonly string pwd = System.Configuration.ConfigurationSettings.AppSettings["Pwd"];
        //static readonly int smtpPort = Convert.ToInt32(System.Configuration.ConfigurationSettings.AppSettings["SmtpPort"]);
        //static readonly string authorName = System.Configuration.ConfigurationSettings.AppSettings["AuthorName"];
        //static readonly string to = System.Configuration.ConfigurationSettings.AppSettings["To"];
    ...
    public class SmtpConfig
    {
        ...
        public SmtpSetting SmtpSetting
        {
            get
            {
                ...
                SmtpSetting smtpSetting = new SmtpSetting();
                smtpSetting.Server = ConfigHelper.GetConfigValue(smtpConfigPath, "Server");
                smtpSetting.Authentication = Convert.ToBoolean(ConfigHelper.GetConfigValue(smtpConfigPath, "Authentication"));
                smtpSetting.User = ConfigHelper.GetConfigValue(smtpConfigPath, "User");
                smtpSetting.Password = ConfigHelper.GetConfigValue(smtpConfigPath, "Password");
                smtpSetting.Sender = ConfigHelper.GetConfigValue(smtpConfigPath, "Sender");
