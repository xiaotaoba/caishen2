...
namespace Pannet.Utility
{
    ...
    public class PageValidate
    {
        ...
        private static Regex RegIdCard = new Regex("^\\d{17}[\\d|X]|\\d{15}$");
        private static Regex RegBankNumber =new Regex("^[0-9]{8,}$");// new Regex("^^(\\d{16}|\\d{19})$");
        ...
        /// 是否是身份证号
        /// </summary>
        /// <param name="inputData">身份证号</param>
        /// <returns></returns>
        public static bool IsIdCard(string inputData)
        {
            Match m = RegIdCard.Match(inputData.ToUpper());
            return m.Success;
        }
        /// <summary>
        /// 是否是银行卡号
        /// </summary>
        /// <param name="inputData">银行卡号</param>
        /// <returns></returns>
        public static bool IsBankNumber(string inputData)
        {
            Match m = RegBankNumber.Match(inputData.ToUpper());
            return m.Success;
        }
        /// <summary>
        /// 是否数字字符串 可带正负号
